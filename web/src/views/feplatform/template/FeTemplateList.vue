<template>
  <div class="p-2">
    <BasicTable @register="registerTable" :rowSelection="rowSelection">
      <template #toolbar>
        <a-button type="primary" @click="handleAdd" preIcon="ant-design:plus-outlined">新增模版</a-button>
...
<script lang="ts" name="feplatform-template-list" setup>
  ...
  import { templateColumns, templateSearchSchema, templateFormSchema } from './Template.data';
  import { list, saveOrUpdate, deleteOne, batchDelete, queryById } from '/@/api/feplatform/template';
