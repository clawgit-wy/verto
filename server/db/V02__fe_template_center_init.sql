...
-- 幂等设计: CREATE TABLE IF NOT EXISTS + INSERT IGNORE（可重复执行，不会丢数据）
-- ============================================================
...
-- 2. 模版版本表
-- -----------------------------------------------------------
CREATE TABLE IF NOT EXISTS `fe_template_version` (
  `id` varchar(36) NOT NULL COMMENT '主键ID',
...
-- 3. 应用创建记录表
-- -----------------------------------------------------------
CREATE TABLE IF NOT EXISTS `fe_app_create_record` (
  `id` varchar(36) NOT NULL COMMENT '主键ID',
  `template_id` varchar(36) NOT NULL COMMENT '模版ID',
